...
(function() {
  var AllGamesPage, GamesListView,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
(function() {
  var GameCardCollection, GameCardListItemView, GameCardListView, GameEndedView, GameMessageCollection, GameMessageListItemView, GameMessageListView, GameMessagesView, GamePage, GameView,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  ...
  GameCardCollection = (function(_super) {
    ...
    GameCardCollection.prototype.view = GameCardListItemView;
...
(function() {
  var MyCardCollection, MyCardView, MyCardsListItemView, MyCardsListView, MyCardsPage,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  MyCardCollection = (function(_super) {
    __extends(MyCardCollection, _super);

    function MyCardCollection() {
      return MyCardCollection.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  var GamesListView, JoinGameItemView, JoinGameOptionView, JoinGameView, MyGameCollection, MyGamesListItemView, MyGamesListView, MyGamesPage,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  MyGameCollection = (function(_super) {
    __extends(MyGameCollection, _super);

    function MyGameCollection() {
      return MyGameCollection.__super__.constructor.apply(this, arguments);
    }

    MyGameCollection.prototype.view = MyGamesListItemView;
...
(function() {
  ...
  App = (function(_super) {
    ...
    App.prototype.initialize = function() {
      this.pages = {};
      this.collections = {};
      this.collections.my_games = new MyGameCollection();
      ...
      this.collections.my_cards = new MyCardCollection();
